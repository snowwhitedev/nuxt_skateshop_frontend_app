<template>
	<div class="social-login">
		<div class="btn social" @click="fbLogin">
		...
		<div class="btn social" @click="twitterLogin">
			<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="btn social" @click="googleLogin">
			<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
	...
	methods:{
		googleLogin(){
			...
			// 					image: "https://lh4.googleusercontent.com/-Ee34bQZY-Lw/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuckACfkENg0U4tIT2l06Ey4rfNDSsg/s96-c/photo.jpg"
			// 				}
