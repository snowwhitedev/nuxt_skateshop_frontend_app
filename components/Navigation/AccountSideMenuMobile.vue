	...
	<div class="account-side-menu">
		<div class="user-info">
			...
			<div class="user-info-bottom">
				<p><span>Member since:&nbsp;</span><span>January 30, 2017</span></p>
			</div>
		</div>
		<div class="dropdown-input" v-click-outside="closePanel">
			<div class="dropdown-input-trigger" @click="onShowOptions">
				<span :class="selectTextClass"><AccountSelectedItemMobile /></span>
			</div>
			<div class="dropdown-options" v-if="showOptions">
				<ul>
					<li class="account"  @click="accountMenu('settings')">
					...
					<li class="user" @click="accountMenu('personinfo')">
					...
					<li class="contact" @click="accountMenu('contact')">
					...
					<li class="alarm large-bottom" @click="accountMenu('notification')">
					...
					<li class="order large-bottom" @click="accountMenu('orders')">
					...
					<li class="shop large-bottom" @click="accountMenu('shop')">
...
<script>
import AccountSelectedItemMobile from '@/components/Widgets/AccountSelectedItemMobile.vue';
import ClickOutside from 'vue-click-outside';
export default {
	name: 'account-side-menu-mobile',
	components:{
		AccountSelectedItemMobile
	},
	directives:{
		ClickOutside
	},
	...
	created(){
		...
		let accMenuItem = path[path.length - 1]
		if (path[path.length - 1] === 'dashboard' && path[path.length - 2] === 'shop'){
			accMenuItem = 'shop';
		}
		this.$store.dispatch('uiprops/setAccountMenuItem', accMenuItem);
		
	},
	methods: {
		accountMenu(menuItem){
			this.$store.dispatch('uiprops/setAccountMenuItem', menuItem);
...
@import "~assets/css/accountmenu.scss";
